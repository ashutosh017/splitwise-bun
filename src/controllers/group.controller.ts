...
export class GroupController {
    ...
    findById = catchAsync(async (req: Request<{ groupId: string }>, res: Response<ApiResponse<GroupSummary>>) => {
    ...
    addMember = catchAsync(async (req: Request<{}, {}, {
        groupId: string,
        memberId: string
    ...
    removeMember = catchAsync(async (req: Request<{}, {}, {
        groupId: string,
        memberId: string
    }>, res: Response<ApiResponse<void>>) => {
        const { groupId, memberId } = req.body
    ...
    getAllMembers = catchAsync(async (req: Request<{ groupId: string }>, res: Response<ApiResponse<Member[]>>) => {
    ...
    delete = catchAsync(async (req: Request<{ groupId: string }>, res: Response<ApiResponse<void>>) => {
        const { groupId } = req.params
    ...
    listGroupsForMember = catchAsync(async (req: Request<{ memberId: string }>, res: Response<ApiResponse<GroupSummary[]>>) => {
